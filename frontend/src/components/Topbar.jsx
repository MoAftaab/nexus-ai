import { Bell, BellRing, CircleHelp, Menu, Search, Sparkles } from 'lucide-react'

export function Topbar({ title, subtitle, onSearch, onMenu, onTour, onBell, onNotifications, escalationCount = 0, notificationCount = 0 }) {
