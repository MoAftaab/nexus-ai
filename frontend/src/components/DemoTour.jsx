...
const script = [
  ...
  { page: 'command', title: 'Read the live telemetry', line: '"These severity and impact-window charts are calculated from the open findings right now — no fixed dashboard values."' },
