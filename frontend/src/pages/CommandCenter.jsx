...
export function CommandCenter({ dashboard, workflow, anomalies, onNavigate, onSelectAnomaly, onScan, scanning }) {
  ...
  return <div className="page command-page">
    <section className="command-hero">
      <div className="hero-copy"><span className="live-chip"><Radio size={13} />Live operational twin</span><h2>From warehouse signals to <em>intelligent actions.</em></h2><p>Warehouse Control Tower AI maps small data defects to their downstream production impact before the shift feels them.</p></div>
