...
export const api = {
  ...
  loadHackathon: (filePath) => request('/api/hackathon/load', { method: 'POST', body: JSON.stringify(filePath ? { file_path: filePath } : {}) }),
  hackathonStatus: () => request('/api/hackathon/status'),
