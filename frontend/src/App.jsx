...
export default function App() {
  ...
  const content = useMemo(() => {
    ...
    if (visiblePage === 'documents') return <Documents onInspect={inspectDocument} onClearDocuments={clearDocuments} onDeleteDocument={deleteDocument} onSelectAnomaly={selectAnomaly} onNavigate={navigate} anomalies={anomalies} documentData={documentData} />
